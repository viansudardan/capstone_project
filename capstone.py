...
with c3:
   ...
   st.markdown("<p style='color: black; padding: 10px 10px 10px 20px;  border-radius: 0px; border: 1px solid #CCCCCC;'> Peningkatan suku bunga di AS akan membuat para investor menginvestasikan modalnya pada pasar AS karena tergiur dengan nilai suku bunga yang tinggi, ini akan berimbas pada nilai tukar mata uang dollar AS yang akan semakin perkasa terhadap mata uang lainnya.</p>", unsafe_allow_html=True)
