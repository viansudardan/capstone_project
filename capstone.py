...
with c6: 
   st.markdown("<p style='color: black; padding: 10px 10px 10px 20px;  border-radius: 0px; border: 1px solid #CCCCCC;'>Nilai mata uang Rupiah juga terkena dampaknya, sampai dengan saat ini valuasinya sudah melemah lebih dari seribu Rupiah semenjak tahun lalu. Jika kondisinya semakin memburuk tidak menutup kemungkinan valuasinya akan semakin melemah jika pemerintah tidak memiliki strategi yang tepat untuk mengatasinya.</p>", unsafe_allow_html=True)
