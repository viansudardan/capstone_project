...
with c3:
   ...
   st.markdown("<p style='color: black; padding: 10px 10px 10px 20px; border-radius: 0px; border: 1px solid #CCCCCC;'> Peningkatan suku bunga di AS akan membuat para investor menginvestasikan modalnya pada pasar AS karena tergiur dengan nilai suku bunga yang tinggi, hal ini akan berimbas pada nilai kurs dollar AS yang akan semakin menguat terhadap mata uang lainnya, terlihat valuasi mata uang dunia yang cenderung menurun dalam waktu setahun terakhir.</p>", unsafe_allow_html=True)
