...
with c3:
   ...
   st.markdown("<p style='color: black; padding: 10px 10px 10px 20px;  border-radius: 0px; border: 1px solid #CCCCCC;'> Peningkatan suku bunga di AS akan membuat para investor menginvestasikan modalnya pada pasar AS karena tergiur dengan bunga yang tinggi, hal ini akan berimbas pada nilai tukar mata uang dollar AS yang akan semakin perkasa terhadap mata uang lainnya.</p>", unsafe_allow_html=True)
...
with c6: 
   ...
   st.markdown("<p style='color: black; padding: 10px 10px 10px 20px;  border-radius: 0px; border: 1px solid #CCCCCC;'>Mata uang Rupiah juga terkena dampaknya, saat ini nilainya sudah melemah lebih dari 1.000 Rupiah semenjak tahun lalu, pada akhir bulan September 2022 kurs Rupiah sebesar 15.175,20 terhadap dollar AS. Tidak menutup kemungkinan akan semakin melemah jika pemerintah tidak memiliki strategi yang tepat untuk mengatasinya.</p>", unsafe_allow_html=True)
